    ...
    <div class="container">
        @if ($antrian->count() > 0)
            ...
            <p class="isi">{{$antrian->tindakan}}</p>
                ...
                <a href="/ResepObat/{{$antrian->id}}" class="btn btn-2">CHECKOUT RESEP OBAT</a>
            ...
            <div class="row">
                ...
                @if ($antrian->status == "Pasien Di Rawat")
                <div class="col">
                ...
                <a href="/ResepObat/{{$antrian->id}}" class="btn btn-2">RESEP OBAT</a>
                @endif
            </div>
            @endif
        @else
