...
<body>
    ...
    <div class="container-fluid sm">
        <div class="row">
            <div class="col-6 bg6">
                <p class="century gothic fw-bold text-light" style="font-size:30px;margin:50% 0 0 50px">Selamat Datang</p>
            ...
            <div class="col-6 bg5">
                ...
                <div class="card text-center layreg" style="width: 50%;">
                    <div class="card-body">
                        <h3 class="card-title century gothic">Login Super Admin</h3>
