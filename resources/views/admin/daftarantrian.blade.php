        ...
        <table class="table table-borderless">
            ...
            <tbody>
                ...
                <tr class="baris text-center">
                    ...
                    <td><a href="/admin/KeluhanPasien/{{$a->id}}" class="btn btn-2">INPUT</a></td>
                    @elseif ($a->status == "Menunggu Hasil Periksa")
                    <td><a href="/admin/KeluhanPasien/{{$a->id}}" class="btn btn-warning">EDIT</a></td>
                    @elseif ($a->status == "Menunggu Respon Pasien")
                    <td><a href="/admin/KeluhanPasien/{{$a->id}}" class="btn btn-warning disable">EDIT</a></td>
                    @endif
                </tr>
                @endforeach
                @endif
